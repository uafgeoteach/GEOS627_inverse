...
\item (0.2) Examine the function \verb+covC()+.
...
\item (0.5) Use \verb+covC()+ to find a covariance function $C(d)$ that reasonably fits the scatterplot of $(\bC_{1000})_{kk'}$ versus $D_{kk'}$ from Problem 3-\ref{prob:Cd}.
%
\begin{enumerate}
