...
\item Explain the pattern in \refFig{fig}c and how it occurs. Comment out the first \verb+error+ statement to annotate the plot in (a) to help your understanding.
