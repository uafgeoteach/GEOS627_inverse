...
In this problem you will replace the quasi-Newton method with three other methods. You will not need to touch the code associated with the forward model .
...
%
\begin{verbatim}
tobs = np.array([3.12,3.26,2.98,3.12,2.84,2.98]).reshape((6,1))
eobs = tobs - dtarget
\end{verbatim}
%
