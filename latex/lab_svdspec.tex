...
\item The function \verb+ex_getG.m+ will return the forward linear model $\bG$ for four models in \citet{AsterE2}. Analyze the matrixplots of $\bG$ for each of the 8 examples listed at the top of \verb+ex_getG.m+. Make sure you understand why they look the way they do.
