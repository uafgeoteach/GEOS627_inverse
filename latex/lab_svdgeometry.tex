...
Four examples of ($2 \times 2$) $\bG$ representing the SVD are presented in Figure~1 of \nfile. We label those as Examples 1--4. Four additional examples (Examples 5--8) are shown in \refFig{fig:2D} for this lab.

\begin{enumerate}

\item Start with \refFig{fig:ex5}.
%
\begin{enumerate}
...
\item In the {\bf top} of \refFig{fig:ex5}, sketch $\be_1$ and $\be_2$ in the left plot. \\
...
\item Repeat the above steps to determine the three other $\bG$ matrices in \refFigab{fig:ex6}{fig:ex8}.
...
\item The {\bf bottom} of \refFig{fig:ex5} represents the mapping $\bG^{\dagger}\Ucolor$. Sketch the following (note that you do not need $\bG^{\dagger}$ for the sketch):
%
\begin{itemize}
...
\item Get some more practice with three more examples in \refFigab{fig:ex6}{fig:ex8}.
...
\item The top of \refFig{fig:ex5} represents $\Vcolor \rightarrow \bG \rightarrow \Ucolor$.
...
\centering
\begin{tabular}{rcc}
Ex 5 & $........$ & \includegraphics[width=11cm]{svd_2D_5} \\ \\ \\
Ex 6 & &\includegraphics[width=11cm]{svd_2D_6} \\ \\ \\
Ex 7 & &\includegraphics[width=11cm]{svd_2D_7} \\ \\ \\
Ex 8 & &\includegraphics[width=11cm]{svd_2D_8} 
\end{tabular}
\caption[]
{{
Examples 5--8.
